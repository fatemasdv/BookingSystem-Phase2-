...
app.post("/api/resources", (req, res) => {
  ...
  // BUG FIX 1: Corrected description to capture the incoming data instead of empty string
...
app.use("/api", (req, res) => {
  // BUG FIX 2: Removed the redundant res.json call to prevent server crash
